...
## Faz 6 — Reklam envanteri, SEO, performans `[x]`
...
| Sayfa | Performans | Erişilebilirlik | En iyi pratikler | SEO | CLS | LCP |
| --- | --- | --- | --- | --- | --- | --- |
| `/` | 99 | 100 | 100 | 100 | 0 | 2,1 s |
| `/takvim` | 99 | 100 | 100 | 100 | 0,001 | 2,1 s |
| `/takvim/[tur]` | 99 | 100 | 100 | 100 | 0,002 | 2,1 s |
| `/mezarlik` | 99 | 100 | 100 | 100 | 0 | 2,0 s |
| `/sunucu/[slug]` (grafikli) | 96 | 100 | 100 | 100 | 0 | 2,7 s |
| `/sunucu/[slug]` (flag'li) | 97 | 100 | 100 | 100 | 0,009 | 2,6 s |
| `/sahipler/[owner_key]` | 99 | 100 | 100 | 100 | 0 | 2,0 s |

Hedef performans ≥ 90 ve CLS < 0,05 idi; her sayfada tutuyor.
